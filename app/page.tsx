...
export default function Home() {
  return (
    <>
      <div className="h-screen bg-black p-3 md:flex">
        ...
        <Link href={'/About'}><h2 className="font-extrabold absolute bottom-3 left-6  text-black p-2 " style={{}}>About</h2></Link>
        ...
        <div className="w-full h-full bg-white flex justify-center items-center " style={{background: `url('rubbing-hands-emoji.avif')`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' , backgroundPosition:'50% 50%',}}>
          ...
          <button className="absolute top-90 left-5 border-spacing-0 border-zinc-900 text-white font-extrabold p-2 bg-black h-10 ">
            Diddy Pics
          </button>
          </a>
